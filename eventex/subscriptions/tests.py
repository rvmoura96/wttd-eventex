...
class SubscribePostTest(TestCase):
    ...
    def test_subscription_email_body(self):
        ...
        self.assertIn('Renan Moura', email.body)
        self.assertIn('12345665443', email.body)
        self.assertIn('rvmoura.96@gmail.com', email.body)
        self.assertIn('11-92345-6789', email.body)
